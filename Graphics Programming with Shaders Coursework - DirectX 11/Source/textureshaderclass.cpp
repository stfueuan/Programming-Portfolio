...
bool TextureShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	result = device->CreateBuffer(&alphaBufferDesc, NULL, &m_alphaBuffer);
	if (FAILED(result))
	{
		return false;
	}
					     ...
					     D3DXMATRIX projectionMatrix, ID3D11ShaderResourceView* texture, float alpha)
{
	...
	dataPtr2 = (AlphaBufferType*)mappedResource.pData;

	dataPtr2->getAlpha = alpha;

...
bool TessellationMeshClass::Initialize(ID3D11Device* device, WCHAR* textureFilename, WCHAR* displacementMapName, WCHAR* bumpMapName)
{
	bool result;
...
bool TessellationMeshClass::InitializeBuffers(ID3D11Device* device)
{
	...
	vertices[0].tangent = D3DXVECTOR3(-1.0f, 0.0f, 0.0f); // at right angles to normal, pointing in positive U
	vertices[0].binormal = D3DXVECTOR3(0.0f, -1.0f, 0.0f); //same as tangent, but in positive V (binormal in this case is more like a bitangent)

	vertices[1].position = D3DXVECTOR3(-1.0f, 1.0f, 0.0f);  // Top left.
	vertices[1].texture = D3DXVECTOR2(0.0f, 0.0f);
	vertices[1].normal = D3DXVECTOR3(0.0f, 0.0f, -1.0f);
	vertices[1].tangent = D3DXVECTOR3(-1.0f, 0.0f, 0.0f); 
	vertices[1].binormal = D3DXVECTOR3(0.0f, -1.0f, 0.0f);

	vertices[2].position = D3DXVECTOR3(1.0f, -1.0f, 0.0f);  // Bottom right.
	vertices[2].texture = D3DXVECTOR2(1.0f, 1.0f);
	vertices[2].normal = D3DXVECTOR3(0.0f, 0.0f, -1.0f);
	vertices[2].tangent = D3DXVECTOR3(-1.0f, 0.0f, 0.0f); 
	vertices[2].binormal = D3DXVECTOR3(0.0f, -1.0f, 0.0f);
	...
	vertices[3].binormal = D3DXVECTOR3(0.0f, -1.0f, 0.0f);

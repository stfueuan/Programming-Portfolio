...
//			fragment_shader_parameters_(NULL),
...

	{
		...
		vertex_streams[0].stride = sizeof(abfw::Mesh::SkinnedVertex);
...
//		vertex_shader_data_.wvp=renderer->projection_matrix()*renderer->view_matrix()*renderer->world_matrix();
		...
		sceGxmSetUniformDataF(vertex_shader_data_buffer, vertex_shader_parameters_bone_matrices_, 0, 16*NUM_BONE_MATRICES, &bone_matrices_data_.bone_matrices[0].m[0][0]);
